...
import { Tag, Sparkles, Copy, Check, ShieldCheck, Clock, ShoppingCart, Loader2, ArrowRight } from 'lucide-react';
    ...
    <div className="py-12 px-2 sm:px-3 md:px-4 lg:px-5 xl:px-6 w-full max-w-[1720px] mx-auto space-y-10 min-h-[70vh]">
      ...
      {loading ? (
        <div className="flex items-center justify-center py-20 text-slate-400 gap-2">
          ...
          <span className="text-xs font-bold">Loading active offers...</span>
        </div>
      ) : coupons.length === 0 ? (
