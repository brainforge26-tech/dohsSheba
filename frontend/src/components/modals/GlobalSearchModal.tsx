...
export function GlobalSearchModal() {
  ...
  return (
    <div className="fixed inset-0 z-[99999] overflow-y-auto bg-white/98 backdrop-blur-xl animate-in fade-in duration-200 font-sans text-slate-800">
      {/* Top Close Button */}
      <button
        onClick={closeSearch}
        className="fixed top-5 right-6 z-50 p-2.5 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-800 transition-all border border-slate-200 active:scale-90 cursor-pointer shadow-sm"
